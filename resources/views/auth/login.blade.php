      ...
      <div class="form-container sign-in-container">
        <form method="POST" action="{{ route('auth.login') }}" class="main-form">
          ...
          <div class="mail{{ $errors->has('email') ? ' has-error' : '' }}">
              <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" style="width: 300px;" placeholder="email......" required autofocus >
          ...
          <div class="pass{{ $errors->has('password') ? ' has-error' : '' }}">
              <input id="password" type="password" class="form-control" placeholder="password......" style="width: 300px;" name="password" required autofocus>
            ...
            <br>
          <div>
              <input class="form-check-input remenber-me pull-left" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
