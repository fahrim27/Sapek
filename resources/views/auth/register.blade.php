...
<div class="form-log" style="margin-top: -4%;">
  <h2 class="header-log">GetBus Sign up or Sign in Form</h2> <br>
    <div class="container" id="container">
      <div class="form-container sign-up-container">
        <form method="post" action="{{ route('auth.regis') }}" class="main-form">
          {{ csrf_field() }}
            <div class=" log{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div>
                    <input id="email" type="email" placeholder="Your email here......" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
                ...
                <div>
                    <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Input Password here....." name="password" required autofocus>
      ...
      <div class="form-container sign-in-container">
        <form method="POST" action="{{ route('auth.login') }}" class="main-form">
          {{ csrf_field() }}
          <h1>Sign in here</h1>
